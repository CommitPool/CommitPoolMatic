...
> {
  ...
  async componentDidMount() {
    ...
    const biconomy = new Biconomy(provider, {
      debug: true,
      apiKey: "5Aq84USkE.c78d71c3-d01c-4e22-b8d0-c14246e55299",
    });
    ...
    biconomy
        .onEvent(biconomy.READY, async () => {
          ...
          wallet = wallet.connect(getWeb3);

          let contractAddress = "0xc129A3E263e05b73685b87cffC69695eB6240eaf";
          let contract = new ethers.Contract(contractAddress, abi, getWeb3);

          let daiAddress = "0x70d1f773a9f81c852087b77f6ae6d3032b02d2ab";
          let daiContract = new ethers.Contract(daiAddress, daiAbi, getWeb3);
  ...
  async createCommitment() {
    ...
    const allowance = await this.daiContract.allowance(
      this.props.account.signingKey.address,
      "0xc129A3E263e05b73685b87cffC69695eB6240eaf"
    );
    if (allowance.gte(stakeAmount)) {
      await this.contract.depositAndCommit(
        this.state.activity,
        distanceInMiles * 100,
        startTimestamp,
        endTimestamp,
